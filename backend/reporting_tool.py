...
class PMReportingTool:
    ...
    def aggregate_updates(
        ...
        for update in updates:
            ...
            all_updates_text.append(
                f"{update.employee} ({update.role}): {update.update}"
            )
    ...
    def _get_default_prompt(self, context_stats: str, context: str) -> str:
        ...
        example = (
            ...
            "* New user authentication flow completed, reducing steps from 5 to 3\n"
            "* Fixed mobile responsive issues on the dashboard\n"
            "* Deployed new monitoring dashboard with real-time alerts for system health\n\n"
            "## Current Focus Areas\n"
            "* Payment UI and payment gateway integration\n"
            "* Database migration and testing\n"
            "* Mobile app testing and UI inconsistencies\n"
            "* PCI compliance for payments\n"
            "* Vendor API delay and analytics dashboard integration\n\n"
            "## Blockers or Challenges\n"
            "* PCI compliance requirements for payments\n"
            "* Vendor API delay blocking analytics dashboard integration\n"
            "* Need for legal review of payment gateway integration\n"
            "* Limited resources for upcoming payment system testing\n\n"
            "## Upcoming Priorities\n"
            "* Complete payment UI and payment gateway integration\n"
            "* Finalize Q4 content strategy and launch plan\n"
